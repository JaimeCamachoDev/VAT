...
namespace JaimeCamacho.VAT.Editor
{
    public class VATsToolWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            {
                SetActiveTab((ToolTab)newTabIndex, false);
            }
        ...
        private void SetActiveTab(ToolTab tab, bool forceRepaint)
        {
            ...
            if (previousTab != tab)
            {
                ...
                if (previousTab == ToolTab.VatPainter && tab != ToolTab.VatPainter && painterPaintingMode)
                {
                    TogglePaintingMode(false);
                }
            }
